...
class NotificationsService {
  ...
  Future<void> _backgroundHandler(dynamic message) async {
    // Log the notification data to the console.
    log(message.data.toString());
    log("background notification", name: "FCM Notification");
  ...
  Future<void> _foregroundHandler(dynamic message) async {
    // Log the notification data to the console.
    log(message.data.toString());
    log("foreground notification", name: "FCM Notification");
    // Create a new basic notification with the title and description from
    // the notification data.
    createNewBasicNotification(
      title: message.notification?.title ?? "",
  ...
  Future<void> _openAppWithNotification(dynamic message) async {
    // Log the notification data to the console.
    log(message.data.toString());
    // Get.toNamed(
